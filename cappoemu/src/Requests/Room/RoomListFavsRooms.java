...
public class RoomListFavsRooms extends Handler
{
    @Override
    public void ParseIn(Connection Main, Server Environment)
    {
        ...
        Environment.Append(Integer.toString(6), Main.ClientMessage);
        Room[] Rooms = new Room[Main.Data.Favorite_Rooms.size()];
        int pos = 0;
